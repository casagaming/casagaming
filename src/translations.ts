...
export const translations = {
  fr: {
    ...
    'product.free_shipping_desc': 'Sur les commandes de plus de 20 000 DA',
    'product.warranty': 'Garantie de 2 ans',
    'product.warranty_desc': 'Protection complète',
  ...
  ar: {
    ...
    'product.free_shipping_desc': 'للطلبات فوق 20,000 دج',
    'product.warranty': 'ضمان لمدة سنتين',
    'product.warranty_desc': 'حماية كاملة',
    ...
    'checkout.stop_desk': 'توصيل للمكتب',
